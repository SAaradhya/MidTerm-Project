...
// }
  ...
  return (
    ...
    <>
       ...
       <Route path='/jewellry' element={ <Jewellry  Favorite={Favorate} addToFavorites={addToFavorites} cart={cart} addToCart={addToCart}/>} ></Route>
       <Route path='/Menclothing' element={ <Mens  Favorite={Favorate} addToFavorites={addToFavorites} cart={cart} addToCart={addToCart}/>} ></Route>
       <Route path='/Womenclothing' element={ <WoMens  Favorite={Favorate} addToFavorites={addToFavorites} cart={cart} addToCart={addToCart}/>} ></Route>

       <Route path='/cart' element={ <Cart cart={cart} addToCart={addToCart}/>} ></Route>
       <Route path='/favorites' element={ <Favorites  Favorite={Favorate} cart={cart} addToFavorites={addToFavorites} addToCart={addToCart}/>} ></Route>
       <Route path='/favorites' element={ <Favorites  Favorite={Favorate} cart={cart} addToFavorites={addToFavorites} addToCart={addToCart}/>} ></Route>
